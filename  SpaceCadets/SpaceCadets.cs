...
public class Program
{
    ...
    public static List<dynamic> GetStudentsWithHighestGPA(List<Student> students)
    {
        ...
        double HighestGpa = students_with_all_marks.Max(student => (student.Marks.Sum()) / student.Marks.Length);
        var result = students_with_all_marks.Where(student => (student.Marks.Sum()) / student.Marks.Length == HighestGpa).Select(student => new
        {
            Name = student.Name,
